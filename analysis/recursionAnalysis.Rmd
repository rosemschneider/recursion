...
fig3.model.base <- glmer(Accuracy ~ age.c + (1|TaskItem) + (1|LadlabID), 
...
fig3.model.noint <- glmer(Accuracy ~ prod.group + TaskItem_type+ IHC.c + age.c + (1|TaskItem) +
                     (1|LadlabID), family = "binomial", data = fig3.model.df)
fig3.model.full <- glmer(Accuracy ~ prod.group + TaskItem_type + prod.group:TaskItem_type 
                         + IHC.c + age.c + (TaskItem_type|TaskItem) +
                     (1|LadlabID), family = "binomial", data = fig3.model.df)
...
# visualization
library(effects)
plot(allEffects(fig3.model.int))
```