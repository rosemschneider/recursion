...
```{r}
# discovered a typo
levels(full.data$Response)[levels(full.data$Response)=="NA "] <- NA
# we may want to think of a better way to check typos?
...
ggplot(hc.dev.data, aes(x = LadlabID, y = hc)) + 
  ...
  geom_line() + 
  geom_point(aes(shape = hcprogression, colour = hcprogression), size = 2) +
  scale_color_brewer(palette="Dark2") +
  labs(title="Highest Count Development by Decade Productivity Group",
