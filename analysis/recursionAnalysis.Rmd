...
large.endless.prod <- glmer(EndlessKnower ~ Productivity + IHC.c + (1|LadlabID), 
                            family = "binomial", data = distinct_model.df)
#compare
anova(large.endless.base, large.endless.prod, test = 'LRT')##Productivity is significant

##ALL THREE TOGETHER
large.endless.full <- glmer(EndlessKnower ~ Productivity + Highest_Contig_NN.c + IHC.c + (1|LadlabID), 
                            family = "binomial", data = distinct_model.df)
...
#compare 
anova(large.endless.prod, large.endless.full, test = 'LRT') #n.s.
```
