...
anova(wcn.model.noint, wcn.model.base, test = 'LRT')
...
```{r}
wcn.data %>%
  mutate(prod.group = ifelse(IHC > 99, "IHC > 99", 
                             ifelse(Productivity == "Productive", "Prod. IHC < 99", "Nonproductive")))%>%
  filter(TaskType == "immediate")%>%
...
anova(large.endless.gain.ihc, large.endless.gain, test = 'LRT')
```
